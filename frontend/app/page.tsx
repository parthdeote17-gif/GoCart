      ...
      <div className="relative z-10 w-full">
        {!searchQuery && (
          <div className="max-w-[1500px] mx-auto px-4 w-full pt-28">
            ...
            {/* ✅ PROMOTIONAL BLOCKS (CLEAN GRID UI - NO EXPLORE BUTTON - NO OFF BADGES) */}
            {selectedCategory === "All" && (
              <div className="flex flex-wrap justify-center items-stretch gap-5 mb-16 px-2">
                ...
                <Link href="/" className="w-[100%] md:w-[48%] lg:w-[23.5%] no-underline group">
                  <div className="bg-white p-5 h-full flex flex-col shadow-[0_2px_10px_-3px_rgba(0,0,0,0.08)] border border-slate-100 rounded-[16px] transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-3 gap-y-4 flex-grow">
                ...
                <Link href="/" className="w-[100%] md:w-[48%] lg:w-[23.5%] no-underline group">
                  <div className="bg-white p-5 h-full flex flex-col shadow-[0_2px_10px_-3px_rgba(0,0,0,0.08)] border border-slate-100 rounded-[16px] transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <h3 className="text-[17px] font-bold text-slate-800 mb-4">Appliances</h3>
                    <div className="grid grid-cols-2 gap-x-3 gap-y-4 flex-grow">
                      <div className="flex flex-col items-center">
                ...
                <Link href="/" className="w-[100%] md:w-[48%] lg:w-[23.5%] no-underline group">
                  <div className="bg-white p-5 h-full flex flex-col shadow-[0_2px_10px_-3px_rgba(0,0,0,0.08)] border border-slate-100 rounded-[16px] transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    <h3 className="text-[17px] font-bold text-slate-800 mb-4">Fashion</h3>
                    <div className="grid grid-cols-2 gap-x-3 gap-y-4 flex-grow">
                      <div className="flex flex-col items-center">
