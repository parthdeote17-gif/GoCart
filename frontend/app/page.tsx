                    ...
                    <div className="flex flex-col gap-2 flex-grow">
                      <div className="grid grid-cols-5 gap-2 h-[115px]">
                        <div className="col-span-3 relative rounded-2xl overflow-hidden group/img">
                          <img src="https://www.google.com/imgres?q=cushions&imgurl=https%3A%2F%2Ficmedianew.gumlet.io%2Fpub%2Fmedia%2Fcatalog%2Fproduct%2Fcache%2F7c90eecf75182456ca0a208cc3917af8%2F52121512SD02347%2FIndia-Circus-By-Krsnaa-Mehta-Blaue-Blume-Cushion-Cover-Set-of-2-52121512SD02347-1.jpg&imgrefurl=https%3A%2F%2Findiacircus.com%2Fblaue-blume-cotton-slub-cushion-cover-set-of-2.html%3Fsrsltid%3DAfmBOopcHdTYKykHcwqMhRzYCKgFZsqfsWO01yUYqP_4Vt5463DEdn_r&docid=VfyRoZlTvrDivM&tbnid=dJ2WIcWjdQ1TEM&vet=12ahUKEwi5ub-9hPeSAxUnkVYBHTykB4cQnPAOegQIHhAB..i&w=1200&h=1083&hcb=2&ved=2ahUKEwi5ub-9hPeSAxUnkVYBHTykB4cQnPAOegQIHhAB" referrerPolicy="no-referrer" className="w-full h-full object-cover transition-transform duration-700 group-hover/img:scale-110" alt="Cushions" />
